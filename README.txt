...
4. Use the automatic layout which fetches the top selling products from last week or switch to manual mode to add your products in a grid layout.
...
Yes, in manual mode, you can manually select products from a searchable dropdown list.
...
5. Confirmation dialog when switching from manual to top selling products mode. - screenshot-5.png
